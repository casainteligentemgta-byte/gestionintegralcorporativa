          ...
          <div className="p-10 border-b border-stone-200 bg-slate-50 flex justify-between items-start">
            <div className="flex gap-6 items-center">
               ...
               <div>
                  ...
                  <p className="text-[10px] text-[#4b5563] mt-1 font-medium tracking-wide">Expediente Técnico-Legal de Contratación • {worker.employerName || "CONSTRUCTORA KORE, C.A."}</p>
          ...
          <div className="p-12 flex-1 flex flex-col">
            ...
            <div className="grid grid-cols-[140px_1fr] gap-10 border border-stone-200 p-8 mb-6">
              ...
              <div className="grid grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div className="border-t border-stone-100 pt-3"><DataLabel>Fecha de Nacimiento</DataLabel><DataValue mono>{worker.dob}</DataValue></div>
